  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Generate payslips easily" />
      </Head>
        ...
        <div class="max-w-5xl mx-auto px-4">
          <div class="text-center mb-12">
            ...
            <p class="text-xl text-gray-600">
              Generate professional payslips based on Malaysian EPF, SOCSO, and
              EIS standards
            </p>
          </div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div class="p-6">
                ...
                <ul class="space-y-2 text-gray-600">
                  <li class="flex items-start">
                    ...
                    <span>
                      Automatic calculation of EPF, SOCSO, and EIS contributions
                    </span>
                  </li>
                  <li class="flex items-start">
                    <svg
            ...
            <div class="bg-white rounded-lg shadow-lg overflow-hidden">
              <div class="p-6">
                ...
                <p class="text-gray-600 mb-6">
                  Need to integrate payslip generation into your own system? We
                  offer a RESTful API that provides the same calculation,
